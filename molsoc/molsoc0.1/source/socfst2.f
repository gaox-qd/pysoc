...
C
     ...
     $           LD,IMO,IMOA,IMOB
C
      REAL :: CPUTOLD,ENERSUMA,ENERSUMB
      REAL, DIMENSION(3) :: TWOSOA,TWOSOB
      REAL, DIMENSION(NSTO) :: CB1,CA2
C
      INTEGER :: ALLOCATION
...
C
     ...
     $                              BLOCKS)
                      CALL BLDSOC2(ISHL,JSHL,KSHL,LSHL,TWOSOA,TWOSOB,
...
C
      ...
      IF (ALLOCATION /= 0) THEN 
        WRITE(OUT,*) 'SOCFST2: DEALLOCATION FAILED'
        STOP
      END IF
C
C     O~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~O
